...
local experiment_name = "opus_mt_no_lora";
...
local tasks = [mlm_task, opus_mt_task];
        ...
        trained_model: {
            ...
            callbacks: [
                ...
                },
                {
                    ...
                    repo_id: "pakphum/microbert-maltese-opus-mt-no-lora",
                    private: false,
                    commit_message: "Upload microbert maltese opus-mt (no LoRA)"
                }
            ],
        },
        //final_metrics: {
